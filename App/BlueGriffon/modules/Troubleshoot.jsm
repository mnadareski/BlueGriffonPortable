...
let dataProviders = {
  ...
  graphics: function graphics(done) {
    ...
    if (!data.numAcceleratedWindows && gfxInfo) {
      let feature =
//@line 241 "c:\trees\official1.7\toolkit\content\Troubleshoot.jsm"
        gfxInfo.FEATURE_DIRECT3D_9_LAYERS;
//@line 245 "c:\trees\official1.7\toolkit\content\Troubleshoot.jsm"
    ...
    if (gl) {
      ...
      let feature =
//@line 315 "c:\trees\official1.7\toolkit\content\Troubleshoot.jsm"
...
//@line 327 "c:\trees\official1.7\toolkit\content\Troubleshoot.jsm"
